...
public class Checkers extends JPanel implements ActionListener, ItemListener, MouseMotionListener, MouseListener {
    ...
    JLabel rpt=new JLabel("<html>Opponent's <br>Piece</html>");
    JLabel bpt=new JLabel("<html>Your <br>Piece</html>");
    JLabel bp=new JLabel();
    JLabel rk=new JLabel();
    JLabel rkt=new JLabel("<html>Opponent's<br>King</html>");
    JLabel bkt=new JLabel("<html>Your<br>King</html>");
    ...
    private void setupGUI(){
        ...
        rp.setBounds(10, 435, 50, 50);
        rp.setIcon(redN);
        this.add(rp);
        rpt.setBounds(55, 440, 85, 40);
        this.add(rpt);

        bp.setBounds(150, 435, 50, 50);
        bp.setIcon(yellowN);
        this.add(bp);
        bpt.setBounds(195, 440, 50, 40);
        this.add(bpt);

        rk.setBounds(255, 435, 50, 50);
        rk.setIcon(redK);
        this.add(rk);
        rkt.setBounds(300, 440, 85, 40);
        this.add(rkt);

        bk.setBounds(395, 435, 50, 50);
        bk.setIcon(yellowK);
        this.add(bk);
        bkt.setBounds(440, 440, 50, 40);
        this.add(bkt);
